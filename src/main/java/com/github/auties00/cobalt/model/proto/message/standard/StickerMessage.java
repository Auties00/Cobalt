...
import static com.github.auties00.cobalt.model.proto.message.model.MediaMessage.Type.STICKER;
...
public final class StickerMessage implements MediaMessage {
    ...
    final Integer firstFrameLength;

    @ProtobufProperty(index = 12, type = ProtobufType.BYTES)
    final byte[] firstFrameSidecar;
    ...
    final Long stickerSentTimestamp;
