...
/**
 * A model class that represents a WhatsappMessage that refers to a payment cancellation.
...
public final class CancelPaymentRequestMessage implements Message {
   ...
   * Considering that this field's parent class, {@link CancelPaymentRequestMessage}, is used in {@link MessageContainer} which already provides a {@link MessageKey} field,
