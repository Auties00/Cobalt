...
public final record JsonResponse(@NotNull Map<String, ?> data) implements Response {
     ...
     * @throws IllegalArgumentException if {@param json} cannot be parsed
     ...
     * @throws java.util.NoSuchElementException if {@param key} isn't found
     */
    ...
    /**
     * Returns an optional Object converted to {@param <T>} representing the value for the input key
     *
     * @param key the key to search
