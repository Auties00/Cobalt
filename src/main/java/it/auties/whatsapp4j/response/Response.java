...
public interface Response {
    ...
    static @NotNull ResponseNode fromJson(@NotNull String parse) {
        ...
        try {
            ...
            return new ResponseNode(tag, null, new MapResponse(contentMap));
            ...
            if(contentList.get(1) instanceof Map<?, ?> content){
                return new ResponseNode(tag, (String) contentList.get(0), new MapResponse((Map<String, Object>) content));
            }

            return new ResponseNode(tag, null, new ListResponse(contentList));
        }
    }
}