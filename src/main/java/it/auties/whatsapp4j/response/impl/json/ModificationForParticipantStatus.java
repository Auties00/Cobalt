 ...
 * @param inviteCode           if {@code code != 200}, an invitation code to send in a {@link it.auties.whatsapp4j.model.WhatsappGroupInviteMessage}
 * @param inviteCodeExpiration if {@code code != 200}, the expiration for {@code inviteCode} to use in a {@link it.auties.whatsapp4j.model.WhatsappGroupInviteMessage}
 */
