...
public interface OnWhatsappAnyMessageStatus
   ...
   * {@link Listener#onConversationMessageStatus(Whatsapp, MessageInfo, MessageStatus)}.
   *
   ...
   */
  @Override
  void onAnyMessageStatus(Whatsapp whatsapp, Chat chat, Contact contact, MessageInfo info,
