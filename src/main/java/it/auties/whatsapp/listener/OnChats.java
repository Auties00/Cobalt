...
public interface OnChats extends QrDiscardingListener {
    /**
     ...
     * If you also need the messages to be loaded, please refer to {@link OnChatRecentMessages#onChatRecentMessages(Chat)}.
     */
    void onChats();
}