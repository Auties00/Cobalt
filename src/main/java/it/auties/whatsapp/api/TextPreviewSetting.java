...
public enum TextPreviewSetting {
     ...
     * If a message contains an url without a schema(for example wikipedia.com),
     * the message will be autocorrected to include it and a preview will be generated
     */
    ENABLED_WITH_INFERENCE,

    /**
     * Link previews will be generated.
     * No inference will be used.
     */
    ENABLED,
