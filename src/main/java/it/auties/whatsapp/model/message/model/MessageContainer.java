...
public class MessageContainer
  ...
  public static <T extends Message> MessageContainerBuilder builder(@NonNull T message) {
    ...
    switch (message) {
      ...
      case CancelPaymentRequestMessage cancelPaymentRequest ->
          builder.cancelPaymentRequest(cancelPaymentRequest);
      case it.auties.whatsapp.model.message.button.TemplateMessage template ->
      ...
      case EncryptedReactionMessage encReactionMessage ->
          builder.encryptedReaction(encReactionMessage);
  ...
  public Optional<ContextualMessage> contentWithContext() {
    ...
    if (this.ephemeral != null
        && ephemeral.unbox() instanceof ContextualMessage contextualEphemeral) {
    ...
    if (documentWithCaption != null
        && documentWithCaption.unbox() instanceof ContextualMessage contextualEphemeral) {
      return Optional.of(contextualEphemeral);
    }
    if (requestPhoneNumber != null) {
    ...
    if (viewOnceV2Extension != null
        && viewOnceV2Extension.unbox() instanceof ContextualMessage contextualEphemeral) {
      return Optional.of(contextualEphemeral);
    }
