...
public class MessageContainer implements ProtobufMessage {
     ...
     */
    @Builder
    public record ReadOnlyMessageContainer(@ProtobufProperty(index = 1, type = STRING) String textWithNoContext,
                                           @ProtobufProperty(index = 2, type = MESSAGE) SenderKeyDistributionMessage senderKeyDistribution,
                                           @ProtobufProperty(index = 3, type = MESSAGE) ImageMessage image,
                                           @ProtobufProperty(index = 4, type = MESSAGE) ContactMessage contact,
                                           @ProtobufProperty(index = 5, type = MESSAGE) LocationMessage location,
                                           @ProtobufProperty(index = 6, type = MESSAGE) TextMessage text,
                                           @ProtobufProperty(index = 7, type = MESSAGE) DocumentMessage document,
                                           @ProtobufProperty(index = 8, type = MESSAGE) AudioMessage audio,
                                           @ProtobufProperty(index = 9, type = MESSAGE) VideoMessage video,
                                           @ProtobufProperty(index = 10, type = MESSAGE) CallInfo call,
                                           @ProtobufProperty(index = 12, type = MESSAGE) ProtocolMessage protocol,
                                           @ProtobufProperty(index = 13, type = MESSAGE) ContactsArrayMessage contactsArray,
                                           @ProtobufProperty(index = 14, type = MESSAGE) HighlyStructuredMessage highlyStructured,
                                           @ProtobufProperty(index = 16, type = MESSAGE) SendPaymentMessage sendPayment,
                                           @ProtobufProperty(index = 18, type = MESSAGE) LiveLocationMessage liveLocation,
                                           @ProtobufProperty(index = 22, type = MESSAGE) RequestPaymentMessage requestPayment,
                                           @ProtobufProperty(index = 23, type = MESSAGE) DeclinePaymentRequestMessage declinePaymentRequest,
                                           @ProtobufProperty(index = 24, type = MESSAGE) CancelPaymentRequestMessage cancelPaymentRequest,
                                           @ProtobufProperty(index = 25, type = MESSAGE) TemplateMessage template,
                                           @ProtobufProperty(index = 26, type = MESSAGE) StickerMessage sticker,
                                           @ProtobufProperty(index = 28, type = MESSAGE) GroupInviteMessage groupInvite,
                                           @ProtobufProperty(index = 29, type = MESSAGE) TemplateReplyMessage templateReply,
                                           @ProtobufProperty(index = 30, type = MESSAGE) ProductMessage product,
                                           @ProtobufProperty(index = 31, type = MESSAGE) DeviceSentMessage deviceSent,
                                           @ProtobufProperty(index = 32, type = MESSAGE) DeviceSyncMessage deviceSync,
                                           @ProtobufProperty(index = 36, type = MESSAGE) ListMessage list,
                                           @ProtobufProperty(index = 37, type = MESSAGE) FutureMessageContainer viewOnce,
                                           @ProtobufProperty(index = 38, type = MESSAGE) PaymentOrderMessage order,
                                           @ProtobufProperty(index = 39, type = MESSAGE) ListResponseMessage listResponse,
                                           @ProtobufProperty(index = 40, type = MESSAGE) FutureMessageContainer ephemeral,
                                           @ProtobufProperty(index = 41, type = MESSAGE) PaymentInvoiceMessage invoice,
                                           @ProtobufProperty(index = 42, type = MESSAGE) ButtonsMessage buttons,
                                           @ProtobufProperty(index = 43, type = MESSAGE) ButtonsResponseMessage buttonsResponse,
                                           @ProtobufProperty(index = 44, type = MESSAGE) PaymentInviteMessage paymentInvite,
                                           @ProtobufProperty(index = 45, type = MESSAGE) InteractiveMessage interactive,
                                           @ProtobufProperty(index = 46, type = MESSAGE) ReactionMessage reaction,
                                           @ProtobufProperty(index = 47, type = MESSAGE) StickerSyncRMRMessage stickerSync,
                                           @ProtobufProperty(index = 48, type = MESSAGE) InteractiveResponseMessage interactiveResponse,
                                           @ProtobufProperty(index = 49, type = MESSAGE) PollCreationMessage pollCreation,
                                           @ProtobufProperty(index = 50, type = MESSAGE) PollUpdateMessage pollUpdate,
                                           @ProtobufProperty(index = 51, type = MESSAGE) KeepInChatMessage keepInChat,
                                           @ProtobufProperty(index = 53, type = MESSAGE) FutureMessageContainer documentWithCaption,
                                           @ProtobufProperty(index = 54, type = MESSAGE) RequestPhoneNumberMessage requestPhoneNumber,
                                           @ProtobufProperty(index = 55, type = MESSAGE) FutureMessageContainer viewOnceV2,
                                           @ProtobufProperty(index = 56, type = MESSAGE) EncryptedReactionMessage encryptedReaction,
                                           @ProtobufProperty(index = 58, type = MESSAGE) FutureMessageContainer edited,
                                           @ProtobufProperty(index = 59, type = MESSAGE) FutureMessageContainer viewOnceV2Extension,
                                           @ProtobufProperty(index = 35, type = MESSAGE) DeviceContextInfo deviceInfo) implements ProtobufMessage {
