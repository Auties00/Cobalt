...
public final class ButtonsMessage
    ...
    /**
     * Constructs a new builder to create a buttons message without a header.
    ...
    /**
     * Constructs a new builder to create a buttons message with an image header.
     * The result can be later sent using {@link Whatsapp#sendMessage(MessageInfo)}
     *
     * @param header      the document header
     * @param body        the text body of this message
    ...
    /**
     * Constructs a new builder to create a buttons message with a video header.
     * The result can be later sent using {@link Whatsapp#sendMessage(MessageInfo)}
     *
     * @param header      the document header
     * @param body        the text body of this message
    ...
    /**
     * Constructs a new builder to create a buttons message with a location header.
     * The result can be later sent using {@link Whatsapp#sendMessage(MessageInfo)}
     *
     * @param header      the document header
     * @param body        the text body of this message
