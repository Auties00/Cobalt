 ...
 */
public record MessageIndexInfo(@NonNull String type, @NonNull Optional<ContactJid> chatJid, @NonNull Optional<String> messageId, boolean fromMe)
    ...
    public static MessageIndexInfo ofJson(@NonNull String json) {
        try {
            ...
            throw new IllegalStateException("Cannot parse MessageSync: a json exception occurred while parsing %s",
                                            exception);
        }
    }
