...
public class ButtonTemplate implements ProtobufMessage {
    ...
    public static ButtonTemplate of(@NonNull QuickReplyButton quickReplyButton) {
        return ButtonTemplate.builder().quickReplyButton(quickReplyButton).build();
    }
    ...
    public static ButtonTemplate of(@NonNull URLButton urlButton) {
        return ButtonTemplate.builder().urlButton(urlButton).build();
    }
    ...
    public static ButtonTemplate of(@NonNull CallButton callButton) {
        return ButtonTemplate.builder().callButton(callButton).build();
    }
