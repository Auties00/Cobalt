...
public final class FourRowTemplate implements TemplateFormatter {
    ...
    private static FourRowTemplate emptyBuilder(HighlyStructuredMessage content, HighlyStructuredMessage footer, List<ButtonTemplate> buttons) {
        return createBuilder(content, footer, buttons).build();
    }

    private static FourRowTemplateBuilder createBuilder(HighlyStructuredMessage content, HighlyStructuredMessage footer, List<ButtonTemplate> buttons) {
    ...
    private static FourRowTemplate documentBuilder(DocumentMessage title, HighlyStructuredMessage content, HighlyStructuredMessage footer, List<ButtonTemplate> buttons) {
    ...
    private static FourRowTemplate highlyStructuredBuilder(HighlyStructuredMessage title, HighlyStructuredMessage content, HighlyStructuredMessage footer, List<ButtonTemplate> buttons) {
    ...
    private static FourRowTemplate imageBuilder(ImageMessage title, HighlyStructuredMessage content, HighlyStructuredMessage footer, List<ButtonTemplate> buttons) {
    ...
    private static FourRowTemplate videoBuilder(VideoMessage title, HighlyStructuredMessage content, HighlyStructuredMessage footer, List<ButtonTemplate> buttons) {
    ...
    private static FourRowTemplate locationBuilder(LocationMessage title, HighlyStructuredMessage content, HighlyStructuredMessage footer, List<ButtonTemplate> buttons) {
