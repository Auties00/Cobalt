...
public class Button
  ...
  /**
   * The text content of this button. This property is defined only if {@link Button#type()} ==
   * {@link ButtonType#TEXT}.
   */
  @ProtobufProperty(index = 2, type = MESSAGE, implementation = ButtonText.class)
  private ButtonText text;

  /**
   * The native flow content of this button. This property is defined only if {@link Button#type()}
   * == {@link ButtonType#NATIVE_FLOW}.
   */
