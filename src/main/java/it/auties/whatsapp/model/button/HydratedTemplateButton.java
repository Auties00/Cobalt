...
public class HydratedTemplateButton implements ProtobufMessage {
    ...
    public static HydratedTemplateButton of(@NonNull HydratedQuickReplyButton quickReplyButton) {
        return HydratedTemplateButton.builder().quickReplyButton(quickReplyButton).build();
    }
    ...
    public static HydratedTemplateButton of(@NonNull HydratedURLButton urlButton) {
        return HydratedTemplateButton.builder().urlButton(urlButton).build();
    }
    ...
    public static HydratedTemplateButton of(@NonNull HydratedCallButton callButton) {
        return HydratedTemplateButton.builder().callButton(callButton).build();
    }
