...
import static it.auties.whatsapp.io.node.NodeTags.*;
import static it.auties.whatsapp.io.node.NodeTokens.*;
 ...
 * attributes, and content formats including compressed streams, JID pairs, binary data,
