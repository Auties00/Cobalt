...
public class Spec {
    public final static class Whatsapp {
        ...
        public static final String MOBILE_OS_VERSION = "13.0";
        public static final String MOBILE_DEVICE_MODEL = "SM-N950W";
        public static final String MOBILE_DEVICE_MANUFACTURER = "samsung";
        public static final UserAgentPlatform MOBILE_OS_TYPE = UserAgentPlatform.ANDROID;
        public static final UserAgentReleaseChannel MOBILE_RELEASE_CHANNEL = UserAgentReleaseChannel.RELEASE;
    }
