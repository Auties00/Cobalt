...
public class Specification {
    public final static class Whatsapp {
        ...
        public static final String MOBILE_ANDROID_OFFLINE_AB = "{\"exposure\":[\"reg_phone_number_update_colors_prod_universe|reg_phone_number_update_colors_prod_experiment|test\"],\"metrics\":{}}";
