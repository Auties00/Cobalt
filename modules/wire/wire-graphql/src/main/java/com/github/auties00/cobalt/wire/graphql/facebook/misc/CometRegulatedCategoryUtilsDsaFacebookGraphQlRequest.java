 ...
 * {@link CometRegulatedCategoryUtilsDsaFacebookGraphQlResponse}.
 *
 * @implNote This implementation derives its two variables, its persisted id, and its response shape
 * from the operation spec because the {@code LWICometRegulatedCategoryUtilsDSAQuery} module and its
 * compiled {@code .graphql} document are not present in the static bundle of snapshot
 ...
 *
 * @see CometRegulatedCategoryUtilsDsaFacebookGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "LWICometRegulatedCategoryUtilsDSAQuery")
public final class CometRegulatedCategoryUtilsDsaFacebookGraphQlRequest implements FacebookGraphQlOperation.Request {
    /**
     ...
     */
    @WhatsAppWebExport(moduleName = "LWICometRegulatedCategoryUtilsDSAQuery.graphql",
            exports = "params.id", adaptation = WhatsAppAdaptation.DIRECT)
    public static final String DOC_ID = "9950286038342708";
    ...
    public static final String OPERATION_NAME = "LWICometRegulatedCategoryUtilsDSAQuery";
    ...
    /**
     * Constructs a DSA regulated-category query request.
     *
     ...
     */
    public CometRegulatedCategoryUtilsDsaFacebookGraphQlRequest(String adAccountId, String targetSpecString) {
