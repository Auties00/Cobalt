...
/**
 * Parses the Facebook GraphQL response of the delete-pending-knowledge-review mutation built by
 * {@link BizAiKnowledgeReviewDeleteFacebookGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiKnowledgeReviewDeleteFacebookGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiKnowledgeReviewDeleteMutation")
public final class BizAiKnowledgeReviewDeleteFacebookGraphQlResponse implements FacebookGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiKnowledgeReviewDeleteFacebookGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiKnowledgeReviewDeleteFacebookGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiKnowledgeReviewDeleteFacebookGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(Boolean.TRUE.equals(node.getBoolean("success")))
                .build();
        return Optional.of(new BizAiKnowledgeReviewDeleteFacebookGraphQlResponse(result));
    }
