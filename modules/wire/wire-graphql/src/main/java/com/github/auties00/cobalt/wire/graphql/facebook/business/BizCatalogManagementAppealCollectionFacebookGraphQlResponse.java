...
/**
 * Parses the Facebook GraphQL response of the appeal-collection mutation built by
 * {@link BizCatalogManagementAppealCollectionFacebookGraphQlRequest} into a
 ...
 *
 * @see BizCatalogManagementAppealCollectionFacebookGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizCatalogManagementAppealCollectionMutation")
public final class BizCatalogManagementAppealCollectionFacebookGraphQlResponse implements FacebookGraphQlOperation.Response {
    /**
     ...
     */
    private BizCatalogManagementAppealCollectionFacebookGraphQlResponse(BusinessCatalogMutationResult result) {
        this.result = result;
    }
    ...
    public static Optional<BizCatalogManagementAppealCollectionFacebookGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        var result = new BusinessCatalogMutationResultBuilder()
                ...
                .build();
        return Optional.of(new BizCatalogManagementAppealCollectionFacebookGraphQlResponse(result));
    }
