...
/**
 * Parses the Facebook GraphQL response of the ad-entry-points entitlement query built by
 * {@link FetchAdEntryPointsConfigurationFacebookGraphQlRequest} into a list of {@link AdEntryPointEntitlement}.
 *
 ...
 *
 * @see FetchAdEntryPointsConfigurationFacebookGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchAdEntryPointsConfigurationQuery")
public final class FetchAdEntryPointsConfigurationFacebookGraphQlResponse implements FacebookGraphQlOperation.Response {
    /**
     ...
     */
    private FetchAdEntryPointsConfigurationFacebookGraphQlResponse(List<AdEntryPointEntitlement> entitlements) {
     ...
     */
    public static Optional<FetchAdEntryPointsConfigurationFacebookGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var entitlements = parseEntitlements(data.getJSONArray("ctwa_client_entry_point_entitlement"));
        return Optional.of(new FetchAdEntryPointsConfigurationFacebookGraphQlResponse(entitlements));
    }
