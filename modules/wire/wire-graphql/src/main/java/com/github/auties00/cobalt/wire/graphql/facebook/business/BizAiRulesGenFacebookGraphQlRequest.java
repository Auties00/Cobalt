...
/**
 * Builds the Facebook GraphQL mutation that generates suggested WhatsApp Business AI agent rules.
 *
 * <p>The operation takes no variables; it asks the Meta graph endpoint to synthesize a fresh set of agent rules for
 * the authenticated business, returned under {@code xfb_meta_ai_biz_agent_wa_gen_rules}. The reply is
 * consumed through {@link BizAiRulesGenFacebookGraphQlResponse}.
 *
 * @see BizAiRulesGenFacebookGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiRulesGenMutation")
public final class BizAiRulesGenFacebookGraphQlRequest implements FacebookGraphQlOperation.Request {
    /**
     ...
     */
    public BizAiRulesGenFacebookGraphQlRequest() {
    }
