...
/**
 * Builds the Facebook GraphQL query that checks whether a targeting spec is subject to the Taiwan financial
 * services (finserv) regulated-category rules in the WhatsApp Business ad-creation flow.
 *
 ...
 * {@code target_spec_subject_to_taiwan_finserv}; the reply is consumed through
 * {@link CometRegulatedCategoryUtilsTaiwanFinservFacebookGraphQlResponse}.
 *
 * @implNote This implementation derives its two variables from the operation spec because the
 * {@code LWICometRegulatedCategoryUtilsTaiwanFinservQuery} module and its compiled {@code .graphql}
 * document are not present in the static bundle of snapshot {@code 1040120866}; it is one of the
 * Comet ad-creation documents loaded on demand. {@code adAccountID} is a Facebook ad-account
 * identifier (a numeric string), not a WhatsApp address, so it is modelled as a {@code String}
 * rather than a {@link com.github.auties00.cobalt.wire.core.jid.Jid}; {@code targetSpecString} is the
 * already-serialized targeting spec and is likewise a {@code String}.
 *
 * @see CometRegulatedCategoryUtilsTaiwanFinservFacebookGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "LWICometRegulatedCategoryUtilsTaiwanFinservQuery")
public final class CometRegulatedCategoryUtilsTaiwanFinservFacebookGraphQlRequest implements FacebookGraphQlOperation.Request {
    /**
     ...
     */
    @WhatsAppWebExport(moduleName = "LWICometRegulatedCategoryUtilsTaiwanFinservQuery.graphql",
            exports = "params.id", adaptation = WhatsAppAdaptation.DIRECT)
    public static final String DOC_ID = "24059201110339855";
    ...
    public static final String OPERATION_NAME = "LWICometRegulatedCategoryUtilsTaiwanFinservQuery";
    ...
    /**
     * Constructs a Taiwan finserv regulated-category query request.
     *
     ...
     */
    public CometRegulatedCategoryUtilsTaiwanFinservFacebookGraphQlRequest(String adAccountId, String targetSpecString) {
