...
/**
 * Parses the Facebook GraphQL response of the delete-business-AI-rule mutation built by
 * {@link BizAiRuleDeleteFacebookGraphQlRequest} into a {@link BusinessAiMutationResult}.
 *
 ...
 *
 * @see BizAiRuleDeleteFacebookGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebBizAiRuleDeleteMutation")
public final class BizAiRuleDeleteFacebookGraphQlResponse implements FacebookGraphQlOperation.Response {
    /**
     ...
     */
    private BizAiRuleDeleteFacebookGraphQlResponse(BusinessAiMutationResult result) {
        this.result = result;
    }
     ...
     */
    public static Optional<BizAiRuleDeleteFacebookGraphQlResponse> of(JSONObject data) {
        if (data == null) {
        ...
        if (node == null) {
            return Optional.of(new BizAiRuleDeleteFacebookGraphQlResponse(null));
        }

        var result = new BusinessAiMutationResultBuilder()
                .success(Boolean.TRUE.equals(node.getBoolean("success")))
                .build();
        return Optional.of(new BizAiRuleDeleteFacebookGraphQlResponse(result));
    }
