...
/**
 * Parses the Facebook GraphQL response of the WhatsApp Business fetch-quick-promotions query built by
 * {@link FetchQuickPromotionsFacebookGraphQlRequest} into a list of {@link QuickPromotionSurfaceBatch}.
 *
 ...
 *
 * @see FetchQuickPromotionsFacebookGraphQlRequest
 */
@WhatsAppWebModule(moduleName = "WAWebFetchQuickPromotionsQuery")
public final class FetchQuickPromotionsFacebookGraphQlResponse implements FacebookGraphQlOperation.Response {
    /**
     ...
     */
    private FetchQuickPromotionsFacebookGraphQlResponse(List<QuickPromotionSurfaceBatch> batches) {
     ...
     */
    public static Optional<FetchQuickPromotionsFacebookGraphQlResponse> of(JSONObject data) {
        if (data == null) {
            return Optional.empty();
        }

        var batches = parseBatches(data.getJSONArray("quick_promotion_batch_fetch_root"));
        return Optional.of(new FetchQuickPromotionsFacebookGraphQlResponse(batches));
    }
     ...
     *
     * @return the parsed batches, empty when the Meta graph endpoint returned none
     */
