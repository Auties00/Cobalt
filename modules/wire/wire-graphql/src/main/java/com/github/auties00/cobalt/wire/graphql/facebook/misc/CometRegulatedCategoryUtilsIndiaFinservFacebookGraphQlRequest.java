...
/**
 * Builds the Facebook GraphQL query that checks whether a targeting spec is subject to the India financial
 ...
 * {@code target_spec_subject_to_india_finserv}; the reply is consumed through
 * {@link CometRegulatedCategoryUtilsIndiaFinservFacebookGraphQlResponse}.
 *
 * @implNote This implementation derives its two variables from the operation spec because the
 * {@code LWICometRegulatedCategoryUtilsIndiaFinservQuery} module and its compiled {@code .graphql}
 ...
 *
 * @see CometRegulatedCategoryUtilsIndiaFinservFacebookGraphQlResponse
 */
@WhatsAppWebModule(moduleName = "LWICometRegulatedCategoryUtilsIndiaFinservQuery")
public final class CometRegulatedCategoryUtilsIndiaFinservFacebookGraphQlRequest implements FacebookGraphQlOperation.Request {
    /**
     ...
     */
    @WhatsAppWebExport(moduleName = "LWICometRegulatedCategoryUtilsIndiaFinservQuery.graphql",
            exports = "params.id", adaptation = WhatsAppAdaptation.DIRECT)
    public static final String DOC_ID = "9171925689574615";
    ...
    public static final String OPERATION_NAME = "LWICometRegulatedCategoryUtilsIndiaFinservQuery";
    ...
    /**
     * Constructs an India finserv regulated-category query request.
     *
     ...
     */
    public CometRegulatedCategoryUtilsIndiaFinservFacebookGraphQlRequest(String adAccountId, String targetSpecString) {
