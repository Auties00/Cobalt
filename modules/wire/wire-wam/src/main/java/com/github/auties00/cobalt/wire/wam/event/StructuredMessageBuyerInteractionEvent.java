...
@WhatsAppWebModule(moduleName = "WAWebStructuredMessageBuyerInteractionWamEvent")
@WamEvent(id = 7518)
public interface StructuredMessageBuyerInteractionEvent extends WamEventSpec {
