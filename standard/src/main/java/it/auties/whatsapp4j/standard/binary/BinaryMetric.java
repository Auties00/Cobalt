...
/**
 * The constants of this enumerated type describe the various metrics that can be used when sending a WhatsappNode, encrypted using {@link WhatsappSerializer}, to WhatsappWeb's WebSocket
 */
@AllArgsConstructor
