...
import it.auties.whatsapp4j.common.protobuf.message.standard.GroupInviteMessage;
 ...
 */
public record ModificationForParticipantStatus(int code, @JsonProperty("invite_code") String inviteCode,
