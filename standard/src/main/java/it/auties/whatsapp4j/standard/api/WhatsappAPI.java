package it.auties.whatsapp4j.standard.api;
...
import it.auties.whatsapp4j.standard.request.SubscribeUserPresenceRequest;
import it.auties.whatsapp4j.standard.request.UserQueryRequest;
import it.auties.whatsapp4j.standard.response.*;
import it.auties.whatsapp4j.standard.socket.WhatsappSocket;
...
public class WhatsappAPI extends AbstractWhatsappAPI {
     ...
     * @return a CompletableFuture that resolves in a SimpleStatusResponse wrapping the status of the request
     */
    public @NonNull CompletableFuture<SimpleStatusResponse> changePresence(@NonNull IContactStatus presence) {
        if(!(presence instanceof ContactStatus status)) throw new IllegalArgumentException("WhatsappAPI#status only supports ContactStatus as the type of presence");
     ...
     * @return a CompletableFuture that resolves in a SimpleStatusResponse wrapping the status of the request
     */
    public @NonNull CompletableFuture<SimpleStatusResponse> changePresence(@NonNull Chat chat, @NonNull IContactStatus presence) {
        if(!(presence instanceof ContactStatus status)) throw new IllegalArgumentException("WhatsappAPI#status only supports ContactStatus as the type of presence");
