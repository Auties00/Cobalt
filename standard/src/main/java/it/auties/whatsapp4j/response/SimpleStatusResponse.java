...
public final record SimpleStatusResponse(int status) implements JsonResponseModel {
    ...
    /**
     * Returns whether the request associated with this response has a 207 status code
     *
     * @return true if {@code status == 207}
     */
    ...
    /**
     * Returns whether the request associated with this response has a 404 status code
     *
     * @return true if {@code status == 404}
     */
    ...
    public void orElseThrow(@NonNull String message, Object... params){
        Validate.isTrue(successful(), message, params, IllegalStateException.class);
    }
}
