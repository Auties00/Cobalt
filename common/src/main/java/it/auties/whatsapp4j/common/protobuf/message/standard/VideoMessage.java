package it.auties.whatsapp4j.common.protobuf.message.standard;
...
import it.auties.whatsapp4j.common.protobuf.model.misc.InteractiveAnnotation;
...
public final class VideoMessage extends MediaMessage {
   ...
   * The result can be later sent using {@link AbstractWhatsappAPI#sendMessage(MessageInfo)}
   *
