...
public class RegisterListenerProcessor {
     ...
     *
     * @return a list of {@link IWhatsappListener}
     */
    public @NonNull List<IWhatsappListener> queryAllListeners() {
    ...
    private @NonNull Class<? extends IWhatsappListener> cast(@NonNull Class<?> clazz){
        try{
            return clazz.asSubclass(IWhatsappListener.class);
    ...
    private @NonNull IWhatsappListener newInstance(@NonNull Class<? extends IWhatsappListener> clazz){
        try {
