 ...
 * A WhatsappListener can be registered manually using {@link AbstractWhatsappAPI#registerListener(IWhatsappListener)}.
 * Otherwise, it can be registered by annotating it with the {@link RegisterListener} annotation.
 * If the latter option is used, auto-detection of listeners by calling {@link AbstractWhatsappAPI#autodetectListeners()}.
 */
public interface IWhatsappListener {
    /**
     ...
     * Instead, {@link IWhatsappListener#onChats()} and {@link IWhatsappListener#onContacts()} should be used.
     *
     ...
     * If you also need the messages to be loaded, please refer to {@link IWhatsappListener#onChatRecentMessages(Chat)}.
     */
