package it.auties.whatsapp4j.common.protobuf.chat;
...
public class Chat {
   ...
   * Otherwise, it's recommended to use {@link AbstractWhatsappAPI#subscribeToContactPresence(Contact)} to force Whatsapp to send updates regarding the status of the other participant.
   * It's also possible to listen for updates to a contact's presence in a group or in a conversation by implementing {@link IWhatsappListener#onContactPresenceUpdate}.
