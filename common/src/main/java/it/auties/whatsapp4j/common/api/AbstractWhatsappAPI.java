package it.auties.whatsapp4j.common.api;
...
public abstract class AbstractWhatsappAPI {
    protected final WhatsappDataManager manager;
    protected AbstractWhatsappAPI(){
        this.manager = new WhatsappDataManager();
    }
     ...
     */
    public @NonNull AbstractWhatsappAPI autodetectListeners() {
     ...
     */
    public @NonNull AbstractWhatsappAPI registerListener(@NonNull IWhatsappListener listener) {
     ...
     * @throws IllegalArgumentException if the {@code listener} cannot be added
     */
    public @NonNull AbstractWhatsappAPI removeListener(@NonNull IWhatsappListener listener) {
     ...
     */
    public abstract @NonNull WhatsappKeysManager keys();
     ...
     */
    public abstract @NonNull AbstractWhatsappAPI connect();
     ...
     */
    public abstract @NonNull AbstractWhatsappAPI disconnect();
     ...
     * @throws IllegalStateException if a previous connection doesn't exist
     */
    public abstract @NonNull AbstractWhatsappAPI logout();
     ...
     * @throws IllegalStateException if a previous connection doesn't exist
     */
    public abstract @NonNull AbstractWhatsappAPI reconnect();
